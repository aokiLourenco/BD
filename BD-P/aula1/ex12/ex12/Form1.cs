...
namespace ex12
{
    public partial class Form1 : Form
    {
        ...
        private void TestDBConnection(string dbServer, string dbName, string userName, string userPass)
        {
           ...
           + "Initial Catalog = " + dbName + "; uid = " + userName + ";" + "password = " + userPass + ";TrustServerCertificate=True");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            SqlConnection CN = new SqlConnection("Data Source = " + textBox1.Text + ";"
                          + "Initial Catalog = " + textBox2.Text + "; uid = " + textBox2.Text + ";" + "password = " + textBox3.Text + ";TrustServerCertificate=True");
            MessageBox.Show(GetTableContent(CN), "Table Content", MessageBoxButtons.OK);
        }
    }
}
