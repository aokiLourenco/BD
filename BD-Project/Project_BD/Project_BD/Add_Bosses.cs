...
namespace Project_BD
{
    public partial class Add_Bosses : Form
    {
        ...
        private void Add_Boss_DB(string name, string attacks, string Attributes, string description, string class_str, string weakness, string location, string level)
        {
            try
            {
                CN.Open();
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@CharacterID", new SqlCommand("SELECT MAX(CharacterID) FROM Characters",CN));
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Add_Boss_DB(name, attacks, Attributes, description, class_str, weakness, location, level);
